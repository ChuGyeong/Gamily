...
const MyDogAdoption = memo(() => {
   ...
   useEffect(() => {
      const matchingDog = data.find(item => item.desertionNo === myDogId);
      if (matchingDog) {
         setMyDog(matchingDog);
      }
      console.log(matchingDog);
   }, [data, myDogId]);
         ...
         <InnerContainer>
            ...
            <form onSubmit={onSubmit}>
               ...
               <div className="ask-area">
                  ...
                  <p>
                     <strong>
                        입양하는 반려 동물이 어떻게 신청자분과 지내고 있는지 소식을 전해주실 수 있나요?(이메일, 블로그,
                        사진 등)
                     </strong>
                     <label>
