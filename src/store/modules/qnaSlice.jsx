...
const initialState = {
   data: [
      ...
      },
      {
         ...
         username: '푸푸푸푸린푸푸린',
         date: '2023-07-17',
         ask: '있는 천자만홍이 위하여 같이, 가치를 영락과 그리하였는가? 열매를 이상을 간에 그것은 찬미를 그들은 많이 피가 영원히 칼이다. 우리는 피가 품고 새 영락과 얼마나 얼음 아니다.',
      },
      {
         id: 3,
...
export const qnaSlice = createSlice({
   ...
   reducers: {
      addQuestion(state, action) {
         state.data = [...state.data, { id: no++, ...action.payload, username: '홍길동' }];
      },
